...
--
-- Host: 127.0.0.1
-- Generation Time: 28 Jan 2019 pada 07.37
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
(2, 'Anas', 'Jalan Danau Poso', '0876543666', 'Anass', '12343333'),
(4, 'Agus', 'Jalan Danau Buyan', '081188883333', 'Agusantoso', 'abcffff'),
(5, 'Nabila', 'Sawojajar, Malang', '08123456789', 'Nabilaaaa', '123456');
...
--
ALTER TABLE `barang`
 ADD PRIMARY KEY (`id_barang`), ADD KEY `id_kategori` (`id_kategori`) USING BTREE;
...
--
ALTER TABLE `nota`
 ADD PRIMARY KEY (`id_nota`), ADD KEY `id_pembeli` (`id_pembeli`);
...
ALTER TABLE `transaksi`
 ADD PRIMARY KEY (`id_trans`), ADD KEY `id_nota` (`id_nota`), ADD KEY `id_barang` (`id_barang`);
