        ...
        <div class="card">
            <div class="header">
                <div class="row clearfix">
                    ...
                    <center><h1 class="judul">Barang</h1>
                    </div>
                </div>
                <div class="body1">
                    <div class="row">
                    <center><a style="margin: 35px; margin-left: 1px;" href="#tambah" 
                    class="btn btn-primary" data-toggle="modal"><span class="glyphicon glyphiconplus"></span> Tambah</a>
